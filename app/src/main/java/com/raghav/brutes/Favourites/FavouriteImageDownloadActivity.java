...
public class FavouriteImageDownloadActivity extends AppCompatActivity {

    private ImageView imageView,back_btn;
    private Button download_btn,wallpaper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_favourite_image_download);
        setRequestedOrientation (ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        imageView = findViewById(R.id.f_get_image);
        back_btn=findViewById(R.id.f_back_btn);
        layout=findViewById(R.id.id_con);
        Intent intent = getIntent();
        Glide.with(this).load(intent.getStringExtra("img")).into(imageView);

        download_btn=findViewById(R.id.f_d_btn);
        ...
        wallpaper = findViewById(R.id.f_wallpaper);
        wallpaper.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                new AestheticDialog.Builder(FavouriteImageDownloadActivity.this, DialogStyle.FLAT, DialogType.SUCCESS)
                        ...
                        .show();
                WallpaperManager wallpaperManager = WallpaperManager.getInstance(FavouriteImageDownloadActivity.this);
    ...
    private void saveImage()
    {
        ...
        try {
            ...
            Toast.makeText(FavouriteImageDownloadActivity.this, "Image saved in DCIM", Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
            e.printStackTrace();
            Toast.makeText(FavouriteImageDownloadActivity.this, "Error"+e, Toast.LENGTH_SHORT).show();
        }
